...
export default {
    forex: {
        ...
        onlineTradingMessage:
            "One of the fastest growing parts of the forex trading marketplace are retail foreign exchange traders (individuals) who participate in forex trading online, including to seek to profit from currency fluctuations (market changes) hedge currency risk.  This sector participates in the forex trading marketplace using a broker (like MSC) or using a bank. In the case of broker you trade currencies through derivative contracts, which change in value based on the value of the underlying currencies, being a 'base' currency (often USD) and a second currency (called the 'quote' currency).",
        brokerTradingTitle: "Forex trading via a broker",
        brokerTradingMessage:
            "Participating in the forex trading via a broker like MSC means that you have access to real-time pricing of the forex market.  You are quoted buy and sell prices   on our platform. You have the freedom to decide at which price to buy or sell, and vice versa, and you can execute a transaction at any time the relevant markets are open.",
    },
    metal: {
