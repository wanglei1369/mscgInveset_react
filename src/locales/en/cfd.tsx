...
export default {
    ...
    forex: {
        title: "Financial Derivatives Trading",
        aboutForexTitle: "About Financial Derivatives Trading",
        aboutForexMessage:
            "Financial derivatives trading, currency trading, or FX trading, describes the currency exchange market, which is the global, decentralized marketplace where individuals, companies and financial institutions exchange currencies at floating rates.\nThe current floating exchange rate system was adopted in the 1970s. Prior to that a monetary management system called the Bretton Woods Agreement was in existence, in which the exchange prices of currencies against each other were tied and correlated to the reserves of gold.",
        forexMarketTitle: "Financial Derivatives Trading Marketplace",
        forexMarketMessage:
            "Today’s financial derivatives trading marketplace is the world’s largest and most liquid market due to a number of factors which include ease of performing transactions over the internet, ease of international communication and modern transportation.  These factors have contributed to a growing financial derivatives trading marketplace.",
        tradingHourTitle: "financial derivatives Trading Hours",
        tradingHourMessage:
            "Financial derivatives instruments have streaming prices and trading functionality available continuously as follows\nPricing & Trading begin each Monday at 00:05 GMT+3.\nPricing & Trading end each Friday at 23:55 GMT+3.",
        onlineTradingTitle: "Online financial derivatives Trading",
        onlineTradingMessage:
            "One of the fastest growing parts of the financial derivatives trading marketplace are retail foreign exchange traders (individuals) who participate in financial derivatives trading online, including to seek to profit from currency fluctuations (market changes) hedge currency risk.  This sector participates in the financial derivatives trading marketplace using a broker (like MSCGroup) or using a bank. In the case of broker you trade currencies through derivative contracts, which change in value based on the value of the underlying currencies, being a 'base' currency (often USD) and a second currency (called the 'quote' currency).",
        brokerTradingTitle: "Financial derivatives trading via a broker",
        brokerTradingMessage:
            "Participating in the financial derivatives trading via a broker like MSCGroup means that you have access to real-time pricing of the financial derivatives market.  You are quoted buy and sell price on our platform. You have the freedom to decide at which price to buy or sell, and vice versa, and you can execute a transaction at any time the relevant markets are open.",
    },
    metal: {
    ...
    oil: {
        ...
        aboutCommodityMessage:
            "Along with the global currency exchange markets, commodity markets offer opportunities for investors. Commodities have been traded for centuries, and investors’ preference for commodity financial derivatives (including CFDs) is attributed to the major role they play in portfolio diversification and the possibility of generating positive returns. \nInvesting in commodities can be used as a means of risk mitigation (but cannot be guaranteed to do so). \nMSCGroup offers commodity CFDs, which are CFDs whose value is determined by fluctuations in the price of the underlying commodity, such as Brent Crude.  Prices for commodity CFDs are only quoted and can only be traded during the open market hours of the relevant exchange on which the underlying commodity is traded- the trading hours are below. For more information on which commodity CFDs you can trade with us, please review the product list on the MSCGroup platform.",
