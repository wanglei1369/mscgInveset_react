...
export default {
    ...
    oil: {
        ...
        aboutCommodityMessage:
            "Along with the global currency exchange markets, commodity markets offer opportunities for investors. Commodities have been traded for centuries, and investors’ preference for commodity financial derivatives (including CFDs) is attributed to the major role they play in portfolio diversification and the possibility of generating positive returns. \nInvesting in commodities can be used as a means of risk mitigation (but cannot be guaranteed to do so). \nMSC offers commodity CFDs, which are CFDs whose value is determined by fluctuations in the price of the underlying commodity, such as Brent Crude.  Prices for commodity CFDs are only quoted and can only be traded during the open market hours of the relevant exchange on which the underlying commodity is traded- the trading hours are below. For more information on which commodity CFDs you can trade with us, please review the product list on the MSC platform.",
