                        ...
                        <nav className="navbar navbar-expand-lg nav-flex">
                                ...
                                <button
                                    ...
                                    <span onClick={handleNavCollapse}>
                                        <svg viewBox="0 0 100 80" width="40" height="32">
                                            <rect width="80" height="6" fill="#253746"></rect>
                                            <rect y="30" width="80" height="6" fill="#253746"></rect>
                                            <rect y="60" width="80" height="6" fill="#253746"></rect>
                                        </svg>
                                    </span>
                                </button>
                            ...
                            <div className={collapseStatus} id="navbarSupportedContent">
                                <ul className="navbar-nav ml-auto">
                                    ...
                                    <li className="nav-item">
                                        <Link to="/login/trader" className="nav-link">
                                            {t("login.loginTrader")}
                                        </Link>
                                        {/* <span
                                            className="nav-link dropdown-toggle"
